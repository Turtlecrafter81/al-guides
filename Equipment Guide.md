...
[![76mm Single](/resources/76mm%20single%20gr_b.png)](https://azurlane.koumakan.jp/Single_76mm_(3%22/50_caliber_gun)#Type_3)
 ...
 - **[130mm Twin B-2LM](https://azurlane.koumakan.jp/Twin_130mm_(B-2LM)#Type_3)** has the same base damage as 138mm single but with a slightly longer reload, better volume of fire and most importantly fires special normal ammo which have the same modifier versus medium armor as HE ammo. The main advantage of this gun over 138mm single are a better pattern, superior target acquisiton, higher targeting and bullet range, faster shell velocity leading to excellent hit rate, no deadzone and coupled with the excellent volume of fire can help in breaking shields. While this special normal ammo does significantly less damage than HE ammo on heavy armored targets, you shouldn't expect low caliber guns to do relevant damage to heavy armored targets in the first place. What you can expect is that it will do significantly more damage versus light and medium armor. If one were to look really closely for faults with this gun then it'd be its slightly worse firing angle at only 200 degree compared to a full 360 degree like other DD guns and it isn't farmable.
