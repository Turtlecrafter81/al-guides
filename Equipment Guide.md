...
Note: I gotta make the resource file before this line will work.
-->
...
[![76mm Single](/resources/76mm%20single%20gr_b.png)](https://azurlane.koumakan.jp/Single_76mm_(3%22/50_caliber_gun)#Type_3)
 ...
 <!--
                                  **Note: To be added in after images are completed.**
 - **[Prototype 114mm Twin QF Mk IV](https://azurlane.koumakan.jp/Twin_114mm_(QF_Mk_IV_Prototype))** is overall, the best permanently available DD gun. It has slightly lower theoretical DPS when compared to the 138mm Single Mle1929 vs light and medium armour, however its significantly higher rate of fire lets it pull ahead in most scenarios by increasing the frequency of barrages. Aside from the rate of fire, it also has a better shell pattern as well as faster shell velocity leading to excellent hit rate and no deadzone. It does, however, have a slightly lower taarget acquisition range as well as split stats (+25 FP and +20 AA), but the tradeoffs worth it. 
-->
  - **[130mm Twin B-2LM](https://azurlane.koumakan.jp/Twin_130mm_(B-2LM)#Type_3)** has the same base damage as 138mm single but with a slightly longer reload, better volume of fire and most importantly fires special normal ammo which have the same modifier versus medium armor as HE ammo. The main advantage of this gun over 138mm single are a better pattern, superior target acquisiton, higher targeting and bullet range, faster shell velocity leading to excellent hit rate, no deadzone and coupled with the excellent volume of fire can help in breaking shields. It earns the titles of being the single hardest hitting DD gun in the game, to the extent that despite having the slowest reload of all the high ranked DD guns, it is still worth taking most of the time even on ships with only decent guns and great barrages. As a bonus it even has the same +35 FP only matched by the 138mm Single Mle1929. If one were to look really closely for faults with this gun then it'd be its slightly worse firing angle at only 200 degrees compared to a full 360 degree like other DD guns and only one copy is presently availble from a limited event.
 - **[138mm Single Mle1929](https://azurlane.koumakan.jp/Single_138.6mm_(Mle_1929)#Type_3)** is the second hardest hitting DD gun, the hardest vs heavy armor, and it also gives the highest firepower boost of any DD gun (tied with the 130mm Twin B-2LM with +35 FP). However, its rate of fire is a bit slow and it has a bit of a deadzone due to lower bullet range than targeting range. In general it is worth using this gun over the 114mm twin when either FP bonus is needed or your DD gun represents a significant portion of your total DPS vs heavy armor. 
 ...
 - **[100mm Twin Type 98](https://azurlane.koumakan.jp/Twin_100mm_(Type_98)#Type_3)** is generally used on ships with strong barrages. However, its damage output isn't too far behind other alternatives against most targets and its volume of fire is higher than any other gun, but it has fallen in favour of the 114mm Twin QF Mk IV Prototype in almost all scenarios. 
...
**General Primaries** <br/>
<!---
[![pr234mm Triple BL](/resources/pr234mm%20triple%20bl%20gr_s.png)](https://azurlane.koumakan.jp/Triple_234mm_(BL_9.2%22_Mk_XII_Prototype))
[![pr234mm Twin BL](/resources/pr234mm%20twin%20bl%20gr_s.png)](https://azurlane.koumakan.jp/Twin_234mm_(BL_9.2%22_Mk_XII_Prototype))
-->
...
<!---
 - **[406mm Triple Mle1938](https://azurlane.koumakan.jp/Triple_406mm_(Mle_1938_Prototype))** is a close cousin of the Prototype 457mm Twin Mk A. Similar to the 457mm, it has improved AP modifiers, albeit slightly lower across the board. Combined with its higher coefficient it has comparable but slightly lower DPS in a vacuum, however as a triple gun it is able to take advantage of buff/debuff timings that the 457mm would miss. Since burns are not affected by buffs/debuffs, its DPS is usually higher than that of an HE gun with burns against medium and heavy armor targets. It also has a tighter spread than the typical triple gun, and for some reason it has faster than usual shell speed even for an AP gun which results in a lower shell arc (think opposite of Massachusetts), making it laser accurate. As it is more accessible than the 457mm, it should be the go to AP gun for most players. 
 -->
 ...
 - **[Prototype 410mm Triple](https://azurlane.koumakan.jp/Triple_410mm_Prototype_(10th_Year_Type))** has comparable base stats to the Mk6, but fires AP shells. It’s strictly a downgrade to 406mm Triple Mle1938 Prototype but is still usable if you don’t have other AP options.
 - **[381mm Triple M1934](https://azurlane.koumakan.jp/Triple_381mm_(Model_1934)#Type_3)**  is a strict downgrade from the Prototype 406mm triple Mle1938 in damage and accuracy. Despite its unique skill, it is still weaker per volley than the 406mm, on top of having a gimped reload on the 3rd round. Predominantly used on Littorio for her skill and even then it’s debatable.
...
<!--
[![pr305mm Triple SKC](/resources/pr305mm%20triple%20skc%20gr_a.png)](https://azurlane.koumakan.jp/Triple_305mm_(SK_C/39_Prototype))
-->
...
**Damage Guns** <br/>
<!--
[![40mm Sex Bofors](/resources/40mmm%20sexx%20bofors%20gr_s.png)](https://azurlane.koumakan.jp/Sextuple_40mm_Bofors)
-->
...
<!--
 - **[40m Sextuple Bofors](https://azurlane.koumakan.jp/Sextuple_40mm_Bofors)** is the strongest AA damage gun by a significant margin due to incredible base damage. Its other stats are quite similar to the quad bofors, but with the reload of the pompom. It is the gun you should be putting on your AA carry all the time, no questions asked. 
-->
