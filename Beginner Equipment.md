...
#### [Heinkel He-50b](https://azurlane.koumakan.jp/Heinkel_He_50b)
- **Source:** Blue/Purple Ironblood Tech Boxes, One-time item pack in Operation Siren
- **Relevant Ships:** N/A but the [Junkers Ju-87 D-4](https://azurlane.koumakan.jp/Junkers_Ju-87_D-4) it can develop into will be of interest to Torpedo Bomber heavy carriers, especially Graf Zepplin and August von Parseval.
...
The Ship reccs are inspired by WYiS's [Beginning ship guide](https://github.com/YourWaifuIsShip/Azur-Lane-Guides) with a few differences. Look on the wiki and WYiS's guides for more details on the ships mentioned. Some ships will be noted as "Crutch" ships, that is thier value in being a strong statblock/etc for the time being and not really worth the investing of skill books. Some will be marked as "Investments" as their true value will come with investment, though that isn't to say they'd be weak for now. There will be a few other 'tags' for ships; the lack of such will mean the ship will have rather consistent value.
...
- **Useful Ships:** Starter Collection, Shouhou, Mahan-class (investment), Leander (investment), Oklahoma and Nevada (investment), Leander (investment), Nelson (crutch), Norfolk (equipment)
...
- The most popular early-game farming maps. While the equipment can be useful, 3-2 is a more efficient map to farm if that's what you're after. The main reason 3-4 is a popular farming spot is the Foxes. Overall not as efficient a spot to farm as 3-2. While Foxes are strong, they're significantly harder to farm than Dragons, and can be acquired through chapter 3's SOS mission. While she's a rookie mission reward (clear 2-1) and rather common in event builds, she's listed in case you haven't gotten her refitted/maxed out yet as she's the most accessible of the effective tanks. Kagerou's a powerful torpedo nuker for her rarity and comes with a vanguard torpedo buff, which allows her to be used in a variety of fleet builds, including those with heavy cruisers.
...
- As with 3-2, every single equipment drop from here is useful. All five drops are T3 and only the pom-pom has a readily accessible replacement. Shiranui only drops in stage 4 and is with her retrofit a very strong torpedo nuker for her rarity. London shares a similar niche and effectiveness to Leander Kai but with her retrofit, she's able hang in later content, becoming Leander's successor. Shigure is basically a better Javelin whose retrofit makes her similar to Yukikaze (but has a alternate effect when with Yukikaze).
...
The Ship reccs are inspired by WYiS's [Beginning ship guide](https://github.com/YourWaifuIsShip/Azur-Lane-Guides) with a few differences. Look on the wiki and WYiS's guides for more details on the ships mentioned. Some ships will be noted as "Crutch" ships, that is thier value in being a strong statblock/etc for the time being and not really worth the investing of skill books. Some will be marked as "Investments" as their true value will come with investment, though that isn't to say they'd be weak for now. If a ship doesn't have either, then assume they have a rather consistent value curve.

#### Any Event Map
- Did you join during an event? Consider yourself in luck. Farming event maps is one of the most efficient things you could do, regardless of what the event actually drops. Aside from potentially having useful blueprints or ship drops (often earier than normally availble), clearing an event map will reward you with a chunk of event currency, which can be used to purchase a number of useful consumables from the event shop, which typically includes retrofit blueprints and equipment boxes. A list droppable equipment blueprints can be gleam before you start a sortie. Much of this applies towards the levels in war archive save for the event currency.
...
- **Useful Equipment:** Naval Camo, Blue Anti-Air Guns
- **Useful Ships:** Laffey, Javelin, Ayanami (JP), Z23 (CN/EN), Mahan-class (investment), Leander (Investment), Shouhou, Arizona, Oklahoma and Nevada (investment)
- One of the absolute best grinding spots for newer players.  The blue anti-air guns that drop here, while not particular noteworthy, are still useful for the upcoming chapter 3, which has some of the first maps that test your ability to survive in high-aviation fights. Starting in chapter 2, the starter ships are available as map drops, with the starter ship collection providing both a gold rarity quintuple torpedo launcher and the fourth starter ship. All the starters hold up pretty well overall, though Javelin and Laffey have lower initial value. Shouhou provides a mix of healing, offense and with her retrofit, carrier support. She's useful anywhere without heavy enemy airpower. Arizona is the only non-collab BB with healing, and a decently strong one at that. The Nevada class with their retros become pretty strong, making them good early/budget choices for BBs. 
#### 2-3
- **Useful Equipment:** Anti-Air Radar, Fire Extinguisher
- **Useful Ships:** Starter Collection, Shouhou, Mahan-class (investment), Leander (investment), Oklahoma and Nevada (investment), Leander (investment), Nelson (crutch), Norfolk (equipment)
- Another great map to prepare yourself for chapter 3. If you manage to cobble one or two together, the anti-air radar will substantially increase your ability to deal with enemy carriers. Nelson, and her sister Rodney, aren't especially strong ships later in the game, but they're useful early game due to their ease of access, ability to equip CL aux guns, and barrage. Norfolk is noteworthy not for her efficacy as a ship, but because she comes stock with a relatively very powerful blue anti-air gun.
...
#### 3-2
- **Useful Equipment:** Steam Catapult, 127mm Single, SB2C Helldiver, 152mm Single
- **Useful Ships:** Starter Collection, Leander (investment), Charles Ausburne (collection), Souryuu and Hiryuu (Dragons), Langley (investment), Ranger (investment)
- Easily one of the best early-game farming maps. What 2-2 gives you in ship drops, 3-2 gives you in equipment drops. Every single piece of gear here is useful with the exception of the 102mm destroyer gun. while 3-1 and 3-3 give okay drops, any blueprint acquired from those maps is a blueprint not acquired from 3-2. For ship drops, Charles Ausburne is part of the Beaver collection, and the hardest to acquire, being a purple rarity ship. Dragons are often overlooked compared to the Foxes from 3-4, but are significantly easier to acquire, have comparable performance in PvE, and have remodels which make them substantially better for late-game PvE. Langley while seemingly unimpressive beyond her carrier experience boost, becomes an incredible anti-plane/ACV provider for her rarity/cost with her retofit. Ranger post retofit is a pretty strong offensive carrier for her rarity with the potential for some silly damage. Like Shouhou, enemyplanes are her bane.
...
#### 4-2
- **Useful Equipment:** 152mm Triple, 120mm Twin, 40mm Quad Pom-Pom, 203mm Mounted, 150mm Twin TbtsK
- **Useful Ships:** Starter Collection, Leander (investment), London (investment), Langley (investment), Shiranui (investment), London (investment), Shigure
- As with 3-2, every single equipment drop from here is useful. All five drops are T3 and only the pom-pom has a readily accessible replacement. Shiranui only drops in stage 4 and is with her retrofit a rather strong torpedo nuker for her rarity. London shares a similar niche and effecctiveness to Leander Kai but with her retrofit, she's able hang in later content, becoming Leander's successor. Shigure is basically a better Javelin whose retrofit makes her similar to Yukikaze (but has a alternate effect when with Yukikaze)
